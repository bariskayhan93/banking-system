...
describe('PersonService', () => {
    ...
    describe('create', () => {
        ...
        it('should throw ConflictException if email exists', async () => {
            ...
            // Act & Assert
            await expect(service.create(createPersonDto))
                .rejects
    ...
    describe('findOne', () => {
        ...
        it('should propagate NotFoundException when person not found', async () => {
            ...
            // Act & Assert
            await expect(service.findOne(personId))
                .rejects
    ...
    describe('update', () => {
        ...
        it('should handle email conflict during update', async () => {
            ...
            // Act & Assert
            await expect(service.update(personId, updatePersonDto))
                .rejects
                .toThrow(ConflictException);
        });
    });
    ...
    describe('addFriend', () => {
        ...
        it('should throw BadRequestException when adding self as friend', async () => {
            ...
            // Act & Assert
            await expect(service.addFriend(personId, personId))
                .rejects
        ...
        it('should throw ConflictException when friendship already exists', async () => {
            ...
            // Act & Assert
            await expect(service.addFriend(personId, friendId))
                .rejects
                .toThrow(ConflictException);
        });
    });
